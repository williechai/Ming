...
class xFuserZImageTransformer2DWrapper(ZImageTransformer2DModel):
    ...
    def forward(
        ...
        #print(cap_feats.dtype, self.cap_pad_token.dtype)
        #print("cap_feats", [ii.dtype for ii in cap_feats])
        #print("x", [ii.dtype for ii in x])
        #print("encoder_hidden_states_2", [ii.dtype for ii in encoder_hidden_states_2])
        #print([ii.dtype for ii in encoder_hidden_states_2])
        cap_feats = [ii.to(x[0].dtype) for ii in cap_feats]
        encoder_hidden_states_2 = [ii.to(x[0].dtype) for ii in encoder_hidden_states_2]
        ...
        (
            ...
            cap_inner_pad_mask,
            cap_feats_2,
        ) = self.patchify_and_embed(x, cap_feats, patch_size, f_patch_size, ref_hidden_states, encoder_hidden_states_2)
